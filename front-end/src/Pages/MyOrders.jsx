            ...
            <div className="flex flex-col my-10">
              {
                products.slice(0, 4).map((item, index) => (
                  ...
                  gap-4 px-3 w-full">
                    <div className="flex items-start gap-5  w-full md:w-2/4">
                      <img src={item.productImage[0]} className='w-16 sm:w-20' alt="" />
                      <div className="">
                    ...
                    <div className="flex flex-row md:inline-flex justify-between gap-6 w-full md:w-2/4">
