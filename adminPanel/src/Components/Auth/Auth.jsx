...
const Auth = () => {
  ...
  const { setToken, setRole, setloggedInUser, setWithExpiry } = useAdminContext();
  ...
  return (
    <div className='h-screen w-screen'>
      ...
      <div className="h-full flex justify-center items-center">
        <div className="md-w-2/5 px-3 py-3 md:px-6 mt-4 shadow-md">
          {loading && <Spinner />}
          <div className="text-lg md:text-2xl font-Aclonica font-bold text-gray-600 flex justify-center items-center">
            <p className='tracking-widest'>Admin Panel {currentState}</p>
          ...
          <div className="flex flex-col items-center justify-center my-4 md:my-10">
            <form onSubmit={onSubmitFormHandler} className="w-full max-w-md">
              ...
              <div className="w-full max-w-md flex justify-end ">
                <button className="bg-black text-white px-3 shadow-md py-1 rounded-lg int hover:bg-slate-700 hover:tracking-widest duration-500">
